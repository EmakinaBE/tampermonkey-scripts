...
// @grant        none
// @downloadURL  https://raw.githubusercontent.com/EmakinaBE/tampermonkey-scripts/feature/ENWORKFNAV-2986-tm-mark-save-and-close-b/src/workfront/include-scripts/convert-save-into-event.js
// @updateURL	 https://raw.githubusercontent.com/EmakinaBE/tampermonkey-scripts/feature/ENWORKFNAV-2986-tm-mark-save-and-close-b/src/workfront/include-scripts/convert-save-into-event.js
...
(function(window) {
    ...
    function newTaskClickHandler(event) {
        ...
        setTimeout( async () => {
            ...
            newLine.getElement('.hour-type-and-role-add').onclick = (event) => {
                newTaskClickHandler(event);
            }
